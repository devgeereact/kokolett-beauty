...
export type NotificationCategory =
  'booking' | 'payment' | 'review' | 'customer' | 'system';
...
export type NotificationEventKind =
  ActivityKind | 'request' | 'payment' | 'review' | 'new_customer' | 'system';

const KIND_META: Record<
  NotificationEventKind,
  { icon: LucideIcon; tone: Tone; category: NotificationCategory; title: string }
> = {
  created: {
    icon: Calendar,
    tone: 'primary',
...
): (typeof KIND_META)[NotificationEventKind] {
