...
export function InstallPrompt(): JSX.Element | null {
  ...
  return (
    <div className="fixed inset-x-4 bottom-4 z-50 mx-auto flex max-w-md animate-fade-up items-center justify-between gap-4 rounded-2xl border border-border bg-card p-4 shadow-lg">
      <div>
